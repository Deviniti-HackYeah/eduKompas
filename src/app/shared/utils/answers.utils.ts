...
export const mockedAnswerBySurvey = (
  ...
  switch (satisfaction) {
    case 'Kontakt z innymi ludźmi: długie rozmowy, wymiana doświadczeń i opinii':
      return 'Zdaje się, ze mamy do czynienia z przyszłym managerem. Dobrze, powiedz mi jeszcze jakie są Twoje mocne strony?';
    case 'Zajęcia kreatywne: rysowanie, malowanie, komponowanie':
      return 'Zdaje się, ze mamy do czynienia z humanistą! Dobrze, powiedz mi jeszcze jakie są Twoje mocne strony?';
